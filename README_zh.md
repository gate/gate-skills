...
Gate Skills 是一个开放的技能市场，让 AI Agent 能够原生接入 Gate.io 的加密生态。从市场分析、衍生品监控到一键 MCP 配置，全部可通过自然语言完成。
...
> **路径**: `skills/gate-exchange-marketanalysis-skills/`
...
> **路径**: `skills/gate-exchange-futures-skills/`
...
> **路径**: `skills/gate-exchange-spot-skills/`
...
> **路径**: `skills/gate-dex-market-skills/`
...
> **路径**: `skills/gate-mcp-installer-skills/`
...
├── image/                              # 安装截图
└── skills/
    ├── gate-exchange-marketanalysis-skills/   # 市场盘口分析 skill
    │   ├── SKILL.md
    │   ├── CHANGELOG.md
    │   ├── README.md
    │   └── references/
    │       └── scenarios.md
    ├── gate-exchange-futures-skills/          # 合约交易 skill
    │   ├── SKILL.md
    │   ├── CHANGELOG.md
    │   ├── README.md
    │   └── references/
    ...
    │       ├── cancel-order.md
    │       └── amend-order.md
    ├── gate-exchange-spot-skills/             # 现货交易 skill
    │   ├── SKILL.md
    │   ├── CHANGELOG.md
    │   ├── README.md
    │   └── references/
    │       └── scenarios.md
    ├── gate-dex-market-skills/                # DEX 行情 skill
    │   ├── SKILL.md
    │   ├── CHANGELOG.md
    │   └── README.md
    └── gate-mcp-installer-skills/             # MCP 安装 skill
        ├── SKILL.md
        ├── CHANGELOG.md
        ├── README.md
        ├── references/
