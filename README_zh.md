...
| [gate-exchange-auto-invest](#-gate-exchange-auto-invest) | Gate Earn 极速定投（DCA）：创建/更新/终止/加仓计划；支持币种、最小金额、记录、计划详情；现货与活期理财余额上下文 | `2026.3.24-9` | ✅ Active |
...
> **路径**: `skills/gate-exchange-auto-invest/`
...
└── skills/
    ...
    ├── gate-exchange-auto-invest/      # Earn 极速定投（DCA）：计划、记录、现货与 Uni 上下文
