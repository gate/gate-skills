...
| Skill | 描述 | 版本 | 状态 |
|-------|------|------|------|
| [gate-exchange-flashswap](#-gate-exchange-flashswap) | Gate 闪兑查询：支持币对、兑换限额、订单历史与订单详情（只读） | `2026.3.11-5` | ✅ Active |
...
Gate 闪兑查询：支持币对、最小/最大兑换限额、订单历史与单笔订单详情。只读，不执行闪兑。

**示例提示词**：
- `有哪些闪兑支持的币对？`
- `能闪兑 BTC 换 USDT 吗？限额多少？`
- `查一下我的闪兑订单`
- `查看闪兑订单 120841 详情`
...
└── skills/
    ...
    ├── gate-exchange-flashswap/        # 闪兑查询（只读）
