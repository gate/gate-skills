...
| [gate-exchange-crossex](#-gate-exchange-crossex) | Gate CrossEx：跨所订单/持仓/历史查询（Gate、Binance、OKX、Bybit） | `2026.3.12-1` | ✅ Active |
...
Gate CrossEx 跨所统一交易：订单查询、持仓查询、历史查询，支持 Gate、Binance、OKX、Bybit（现货、杠杆、合约）。

**示例提示词**：
- `查询我的全部持仓`
- `查询 GATE_SPOT_BTC_USDT 的订单`
- `查询成交历史`
- `从 Gate 划转 100 USDT 到 Binance`
...
└── skills/
    ...
    ├── gate-exchange-crossex/          # CrossEx 跨所订单/持仓/历史
