...
| Transfer, send tokens, send to address, batch transfer, withdraw to wallet, "send 1 ETH to 0x...", "transfer USDT", "move tokens", "pay someone", "send crypto to a friend" | [references/transfer.md](./references/transfer.md) |
...
| Authentication failure | `400`, `401`, `unauthorized` | Follow §3 of [gate-runtime-rules.md](./gate-runtime-rules.md) |
...
| Transfer or send tokens to an address | [references/transfer.md](./references/transfer.md) |
...
| "Place a limit order" / "Spot trading" / "Futures position" | CEX trading skills |
...
1. **Authentication first**: Verify `mcp_token` validity before all operations; on failure follow §3 of [gate-runtime-rules.md](./gate-runtime-rules.md).
