...
- **Liquidity + weekend vs weekday (Case 10):** Trigger: e.g. “liquidity”, “weekend vs weekday”, “compare weekend and weekday”. Spot: get_spot_order_book → get_spot_candlesticks(90d) → get_spot_tickers. Futures: get_futures_order_book → get_futures_candlesticks(90d) → get_futures_tickers. Order book for current depth; 90d candlesticks to split weekend vs weekday volume and return; compare and summarize.
