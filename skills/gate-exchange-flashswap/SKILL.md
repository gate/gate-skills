...
version: "2026.3.23-1"
updated: "2026-03-23"
description: "Gate Flash Swap: list supported pairs, preview quotes, execute flash-swap conversions, and query swap orders/history. Use when the user asks to convert/exchange coins via Flash Swap (not spot/futures trading)."
---
