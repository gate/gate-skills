...
- Installs Gate MCP servers for Cursor.
...
```bash
bash skills/gate-mcp-cursorinstaller/scripts/install.sh --no-skills
```
...
```bash
# Local CEX + Dex
bash skills/gate-mcp-cursorinstaller/scripts/install.sh --mcp main --mcp dex

# Remote CEX public + exchange
bash skills/gate-mcp-cursorinstaller/scripts/install.sh --mcp cex-public --mcp cex-exchange
```
...
- MCP fragments: `scripts/mcp-fragments/cursor/`
