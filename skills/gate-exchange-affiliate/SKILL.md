...
version: "2026.3.30-1"
updated: "2026-03-30"
description: "Use this skill for partner/affiliate commissions, applications, eligibility, and summary stats. Constraints: `transaction_history` and `commission_history` allow max 30 days per request; segment longer ranges (up to 180 days). `cex_rebate_get_partner_agent_data_aggregated` supports up to 180 days in one request (do not split when ≤180 days). Trigger phrases: 'affiliate', 'rebate', 'commission', 'partner earnings', 'apply for affiliate', 'eligibility', 'application status', 'overall statistics'."
---
