...
| Query aggregation | Orders / entrustments / trades / positions per **Case Routing**—**not** a full **`gate-exchange-assets`** audit; scenario **7** is futures **orders and entrustments** only |
...
"Show my recent futures entrustments and open perp orders."
