---
name: gate-exchange-tradingcopilot
...
| Full cross-account asset audit, sub-account management | `gate-exchange-assets` / `gate-exchange-assetsmanager` / `gate-exchange-subaccount` |
