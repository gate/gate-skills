...
- Renamed skill directory and `name` frontmatter from **`gate-exchange-asset-manager`** to **`gate-exchange-assetsmanager`** (per request; naming-rule waivers as documented for this skill).
